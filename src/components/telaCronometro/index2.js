...
import LabelCronometro from '../LabelCronometro/index'
...
class Contador extends React.Component{
    ...
    render(){
        return(
            <div>
                <h1 class ="mostrar">{this.mostrarTimeComZeros(this.state.horas)}:{this.mostrarTimeComZeros(this.state.minutos)}:{this.mostrarTimeComZeros(this.state.segundos)}:{this.mostrarTimeComZeros(this.state.centesimos)}</h1>
                <div class="botoesDoCronometro">
